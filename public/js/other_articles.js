...
fetch('../articles.json')
    ...
    .then(articles => {
        let gamingArticles = articles.filter(article => article.tag !== 'Gaming' && article.tag !== 'Esports' && article.tag !== 'Entertainment');
...
function createArticles(articles) {
    const articlesContainer = document.getElementById('otherarticlesContainer'); // Get reference to the container
