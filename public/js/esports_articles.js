...
fetch('../articles.json')
    ...
    .then(articles => {
        let gamingArticles = articles.filter(article => article.tag === 'Esports');
...
function createArticles(articles) {
    const articlesContainer = document.getElementById('esportsarticlesContainer'); // Get reference to the container
